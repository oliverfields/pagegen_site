    ...
    <div id="page">
     <article id="content">
        ...
        <div class="clearfix prev-next-links">
          <div id="previous-link">{{previous_link}}</div>
          <div id="next-link">{{next_link}}</i></div>
        </div>
        <div id="footer">Copyright &#169; {{year}} Oliver Fields<br />Generated by <a id="footer-logo" href="https://pagegen.phnd.net"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#pagegen-then-factory-logo"></use></svg></a><br /><a href="{{page_relative_url}}.txt" title="Page source" target="_blank"><i class="fas code-999999"></i></a></div>
      </article><!-- /content -->
      <div id="top-bar">
        <a href="{{base_url}}">

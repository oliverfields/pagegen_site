    ...
    <div id="page">
     <article id="content">
        ...
        <div class="clearfix prev-next-links">
          ...
          <div id="previous-link"><i class="fas arrow-left-3E4349"></i> <a href="${page.previous_page.url_path}">${page.previous_page.title}</a></div>
          % endif
          % if page.next_page:
          <div id="next-link"><a href="${page.next_page.url_path}">${page.next_page.title}</a> <i class="fas arrow-right-3E4349"></i></div>
          % endif
        </div>
